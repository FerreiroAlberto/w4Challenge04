...
- ¿Qué renderiza?
  > Info (mensaje de estado) + Display (teléfono marcado) + Keyboard (teclado) + Actions (botones llamar y colgar)
- ¿Qúe interacciones del usuario tiene?
- > Action: input del usuario sobre botones llamar y colgar. Keyboard: input del usuario sobre botones numéricos
- ¿Qué información recibe y desde donde?
- > Valores (Key) + Acciones (Action)
